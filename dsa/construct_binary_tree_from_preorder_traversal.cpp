// Construct Tree from Preorder Traversa
// https://practice.geeksforgeeks.org/problems/construct-tree-from-preorder-traversal/1/?company[]=Amazon&company[]=Amazon&page=4&query=company[]Amazonpage4company[]Amazon
...
/*
	 ...
	 has only two possible values ‘L’ and ‘N’. The value ‘L’ in preLN[] indicates 
	 that the corresponding node in Binary Tree is a leaf node and value ‘N’ indicates 
